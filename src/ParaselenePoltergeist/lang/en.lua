ParaselenePoltergeist.localizationStrings = {
    ...
    MUST_BE_IN_SELECTION_MODE = 'You must be in the housing editor selection mode to capture the furniture placement.',
    MUST_NOT_BE_IN_EDITOR_MODE = 'Actions cannot be invoked while in the housing editor.',
    ...
    UNABLE_TO_MOVE_FURNITURE = 'Unable to move the furniture.',
